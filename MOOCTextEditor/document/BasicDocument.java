...
public class BasicDocument extends Document 
{
	...
	public int getNumWords()
	{
		...
		List<String> abc= this.getTokens("[a-zA-Z]+");
		return abc.size();
	...
	{
		List<String> abc= this.getTokens("[^.!?]+");
		return abc.size();
	...
	{
		int num=0;
		List<String> abc= getTokens("[a-zA-Z]+");
		for (String z:abc)
		{
			num+=countSyllables(z);
				}
	...
	public static void main(String[] args)
	{
		...
		System.out.println("\n Checking Flesch score");
		Document aaa= new BasicDocument("Lorem ipsum dolor sit amet, qui ex choro quodsi moderatius, nam dolores explicari forensibus ad.");
		System.out.println(aaa.getText()+"\nFlesch score:\t"+aaa.getFleschScore()); 
		aaa= new BasicDocument("Here is a series of test sentences. Your program should \"\r\n" + 
				"				+ \"find 3 sentences, 33 words, and 49 syllables. Not every word will have ");
		System.out.println(aaa.getText()+"\nFlesch score:\t"+aaa.getFleschScore());  
