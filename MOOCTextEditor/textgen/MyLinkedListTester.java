...
public class MyLinkedListTester {
    ...
    public void testAddEnd() {
        ...
        Integer ccc=new Integer(emptyList.get(0));
        assertEquals("Add to empty list: check if element 0 is correct", (Integer)123456,ccc);
        assertEquals("Add to empty list: check return value"+ccc, true, b);
